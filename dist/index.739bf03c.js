...
parcelHelpers.export(exports, "fetchResults", ()=>fetchResults);
...
let inputValue = ``;
let currentPage = 1;
const fetchResults = async (userInput, currentPage1)=>{
...
const galleryFunctionality = async ()=>{
    try {
        if (inputValue === ``) {
            (0, _notiflixDefault.default).Notify.info("Input cannot be empty!");
            return;
        }
        const response = await fetchResults(inputValue, currentPage);
        if (response.hits.length === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
        else {
            createGallery(response.hits);
            moreBtn.style.display = "block";
            if (currentPage === 1) (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${response.totalHits} images.`);
        ...
        (0, _notiflixDefault.default).Notify.failure("An error occured...");
    }
};
...
},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix":"5z0Oc","notiflix/dist/notiflix-3.2.6.min.css":"1IPtg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","axios":"jo6P5"}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"kaxSc":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"1IPtg":[function() {},{}],"gkKU3":[function(require,module,exports) {
